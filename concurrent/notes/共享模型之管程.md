...
![](../../images/20210918134747.png)

数组对象

![](../../images/20210918134818.png)

其中 Mark Word 结构包括：对象哈希码、对象分代年龄、锁的状态

![](../../images/20210918134852.png)
...
![](../../images/20210922095244.png)

- 这时 Thread-1 加轻量级锁失败，进入锁膨胀流程
  - 即为 Object 对象申请 Monitor 锁，让 Object 指向重量级锁地址
  - 然后自己进入 Monitor 的 EntryList BLOCKED

![](../../images/20210922095303.png)
...
![](../../images/20210922102314.png)

自旋失败的情况

![](../../images/20210922102429.png)
...
![](../../images/20210922103750.png)

![](../../images/20210922103835.png)

#### 偏向状态

64 位虚拟机对象头格式

![](../../images/20210925215530.png)
...
![](../../images/20211009174119.png)

1. 调用 Unsafe.unpark(Thread_0)方法，设置_counter 为1
2. 唤醒_cond 条件变量中的 Thread_0
3. Thread_0 恢复运行
4. 设置_counter = 0

![](../../images/20211009174413.png)
